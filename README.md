...
### [⬇ Download PickMoji 1.0.3](https://github.com/MrGolden1/PickMoji/releases/download/v1.0.3/PickMoji-1.0.3-Setup.exe)

The installer — a small per-user install, no admin rights needed. Prefer not to install? Get
the [portable ZIP](https://github.com/MrGolden1/PickMoji/releases/download/v1.0.3/PickMoji-1.0.3-win64.zip),
